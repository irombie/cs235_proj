...
class LeNet:
    ...
    def build_model_lenet(img_h, img_w, depth, numClasses):
        ...
        model.add(Conv2D(20, (2,2), strides=(1, 1), input_shape=inp)) #Make the size of activation map integer using the formula (W−F+2P)/S+1
        ...
        model.add(Conv2D(50, (2, 2), strides=(1, 1),input_shape=inp))
