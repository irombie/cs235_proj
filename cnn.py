...
class LeNet:
    ...
    def build_model_lenet(img_h, img_w, depth, numClasses):
        ...
        model.add(Conv2D(40, (4,4), strides=(2, 2), input_shape=inp)) #Make the size of activation map integer using the formula (W−F+2P)/S+1
        ...
        model.add(Conv2D(100, (4, 4), strides=(2, 2),input_shape=inp))
